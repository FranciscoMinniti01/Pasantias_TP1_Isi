...
class AddRecyclerViewAdapter(private val context: Context, private val onRecycleClickListener: OnRecycleOnClick): RecyclerView.Adapter<BaceViewHolder<*>>() {
    ...
    inner class RecyclerViewHolder(itemView: View):
        ...
        override fun bind(item: ModelDevices, position: Int) {
            if (!item.Name.isNullOrEmpty()){
                ...
                itemView.List_Button.textAlignment = Gravity.RIGHT//= Gravity.LEFT
                ...
                itemView.List_Button.text = context.getString(R.string.Error)
            }
        }
    }
